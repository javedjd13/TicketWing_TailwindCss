  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-[#EFF2F2]">
      <div className="bg-[#FFFFFF] p-8 rounded-[22px] shadow-lg text-center w-full max-w-md md:w-[600px] md:h-[425px]">
        ...
        <button className="w-full h-[79px] bg-[#EA4335] text-white py-2 px-4 rounded-[40px] mb-4 flex items-center justify-center">
          <img src={googleLogo} alt="google" className="mr-2" />
          Login with
          <span className="font-bold ml-1">Google</span>
        </button>
        <button className="w-full h-[79px] bg-[#3C5A99] text-white py-2 px-4 rounded-[40px] flex items-center justify-center">
